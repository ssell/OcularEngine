...
#pragma once
#ifndef __H__OCULAR_EDITOR_STRING_PROPERTY__H__
#define __H__OCULAR_EDITOR_STRING_PROPERTY__H__
...
namespace Ocular
{
    ...
    namespace Editor
    {
         ...
         *
         * Pre-built property display for string variables.
         */
        class StringProperty : public PropertyWidget
        {
        public:

            StringProperty(QWidget* parent = nullptr);
