...
namespace Ocular
{
    namespace Math
    {
        ...
        {
            return Quaternion(Quaternion_Internal(lhs.getInternal()->quat * glm::vec3(rhs.x, rhs.y, rhs.z)));
        }

        Vector4<float> operator*(Quaternion const& lhs, Vector4<float> const& rhs)
        {
            return Quaternion(Quaternion_Internal(lhs.getInternal()->quat * glm::vec4(rhs.x, rhs.y, rhs.z, rhs.w)));
        }
